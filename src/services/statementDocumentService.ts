 ...
 * hold any number of documents (the monthly statement plus invoices,
 * credit notes, corrections, ...). Group by month with
 ...
 * folder - which may contain any number of files, not exactly one - and
