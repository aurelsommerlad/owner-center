...
/**
 * Statement PDFs for a property/year, newest month first.
 *
 ...
 * folder structure and return the same StatementDocument[] shape, filling
 * in a real `driveFileId`. The authorization check - that the caller's
