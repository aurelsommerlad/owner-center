 ...
 */
export function DataUnavailableNotice({ text }: { text: string }) {
  return (
    <div className="rounded-2xl border border-line bg-[#F1EDE4]/60 px-4 py-3 text-sm text-ink-soft">{text}</div>
  );
}
